...
(function() {
							...
							function(B) {
								...
								try {
									...
									if (this.cg.inPopup
										...
										for ( var F = 0; F < E.length; F++)
											E[F].bH().$.onbeforeunload = E[F]
													.getWindow().$.onunload = E[F]
	...
	(function() {
		...
		a.hf = new window["\122\x65\x67\105\170\x70"](
				"\x5e\x77\167\167\x5c\x2e");
		a.hg = new window["\122\145\x67\105\x78\x70"]("\x3a\x5c\144\x2b\x24");
		a.lS = function(q) {
															...
															.sendCommand(
																	...
																	function(t) {
																		...
																		if (t
																				.checkError())
																			return;
																		var v = "\x43\157\x6e\x6e\145\143\x74\x6f\162\x2f\x43\x6f\156\x6e\145\x63\164\157\x72\x49\156\x66\x6f\057";
																		a.ed = t
																				.selectSingleNode(v
																						+ "\x40\163").value;
																		a.bF = t
																		...
																		q.config.thumbsEnabled = t
																				.selectSingleNode(v
																						+ "\x40\x74\x68\x75\x6d\142\163\105\x6e\141\x62\x6c\x65\x64").value == 'true';
																		q.config.thumbsDirectAccess = false;
																		if (q.config.thumbsEnabled) {
																			u = t
																					.selectSingleNode(v
																							+ "\x40\x74\150\x75\x6d\142\163\x55\162\154");
																			if (u)
																				q.config.thumbsUrl = u.value;
																			u = t
																					.selectSingleNode(v
																							+ "\100\164\150\x75\155\142\163\104\x69\162\x65\x63\164\x41\143\x63\145\163\163");
																			if (u)
																		...
																		q.config.imagesMaxWidth = parseInt(
																				t
																						.selectSingleNode(v
																								+ "\100\151\x6d\147\127\151\144\x74\150").value,
																				10);
																		q.config.imagesMaxHeight = parseInt(
																				t
																						.selectSingleNode(v
																								+ "\x40\151\x6d\x67\x48\145\x69\147\150\164").value,
																				10);
																		u = t
																				.selectSingleNode(v
																						+ "\x40\165\160\154\157\x61\144\115\141\170\123\151\172\145");
																		...
																		u = t
																				.selectSingleNode(v
																						+ "\100\x75\x70\154\x6f\141\x64\103\150\x65\143\x6b\111\155\141\x67\x65\x73");
																		q.config.uploadCheckImages = u ? u.value == 'true'
																				: false;
																		var w = t
																				.selectSingleNode(v
																						+ "\100\160\x6c\x75\147\x69\x6e\x73"), x = w
																				&& w.value;
																		if (x
																				&& x.length)
																			m
	...
	(function() {
							...
							bz : function I(G) {
										...
										.on(
												...
												function L(J) {
													if (J.data.space == 'mainMiddle') {
														...
														if (!g)
															K = u[0] + u[3];
														J.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content' style='display:none;'></h4><div class='files_thumbnails fake no_list' role='list'></div>"
																+ K + '</div>';
													}
												});
								G
														...
														G
																.eU({
																	selectFile : {
																		label : G.lang.Select,
																		onClick : function() {
																			var N = G.aG['filesview.filesview'], O = N.tools
																					.dH();
																			if (O)
																				N
																						.oW(
								...
								G
										.bD(
												...
												{
													exec : function(J) {
														var K = J.layout.pn(), L = J.aG['filesview.filesview'], M = L.tools
																.dH();
														K.focus();
														M && M.focus();
													}
		...
		function y() {
			return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5
					&& window.top[a.nd + "\x63\x61\164\x69\157\x6e"][a.jG
		...
		function z() {
			var G = a.aG.hS('filesview', 'filesview', {
				...
				hA : null,
				pq : 0
			}), H = "\x50\154\x65\x61\x73\145\040\x76\x69\x73\x69\x74\040\x74\150\145\x20\074\141\x20\x68\162\x65\x66\075\x27\x68\x74\164\x70\072\057\057\143\x6b\x66\151\x6e\144\x65\162\056\x63\x6f\x6d\x27\x20\x74\x61\x72\147\x65\x74\x3d\047\x5f\142\154\141\x6e\x6b\x27\x3e\x43\113\x46\151\x6e\x64\145\x72\x20\x77\x65\142\040\x73\x69\164\x65\x3c\x2f\141\076\x20\164\x6f\040\x6f\x62\164\x61\151\156\x20\x61\040\166\141\x6c\151\144\040\x6c\x69\143\x65\x6e\163\x65\x2e", I = "\124\150\x69\163\x20\151\163\040\164\150\145\040\104\x45\115\117\x20\166\145\162\163\151\x6f\x6e\040\157\146\x20\x43\x4b\x46\151\156\x64\x65\162\x2e\040"
					+ H, J = "\x50\x72\157\x64\165\143\x74\040\154\x69\x63\x65\156\163\x65\040\x68\x61\x73\x20\145\170\160\151\162\145\x64\x2e\x20"
					+ H;
			G.qX = function() {
				return I;
			};
														...
														if (U
																...
																&& (!g
																		...
																		|| aa.$.top.location.href
																				.match(/ckfinder.html/) || aa.$.top.name == 'CKFinderpopup')) {
												...
												function aa(S, T) {
													...
													try {
														...
														if (N && W >= 37
															...
															} else if (W == (M.app.lang.dir == 'rtl' ? 37
																	: 39)) {
																U = P.rowNode();
																if (U.ge())
																	aT.tools
															...
															} else if (W == (M.app.lang.dir == 'rtl' ? 39
																	: 37)) {
																U = P.rowNode();
																if (U.gE())
																	aT.tools
							...
							function Z(L) {
								...
								if (!M.files.length)
									...
									var V = function(aa, aT) {
										var bm = aa.name.toLowerCase(), bW = aT.name
												.toLowerCase();
			...
			G.tools.qc = function(L) {
				...
				if (O.filesize)
					P.push('<td>'
							+ i.formatSize(L.size, this.ib.app.lang, true)
							+ '</td>');
				if (O.date)
			...
			getThumbnailUrl : function(G) {
				...
				if (K && (K = K[0])) {
					if (J.config.thumbsEnabled && J.rQ.rO.test(K)) {
						...
						if (H && J.config.thumbsDirectAccess)
							return J.config.thumbsUrl
									...
									+ (!G ? ''
											: '?hash='
													+ J
															.getResourceType(N.folder.type).hash
													+ '&fileHash=' + L);
						var M = {
							FileName : I
						};
						if (G)
							M.fileHash = L;
						return J.connector.composeUrl('Thumbnail', M,
	...
	(function() {
		...
		a.application.prototype.focus = function() {
			(this._.activeElement ? k.eB(this._.activeElement) : this.document
					.getWindow()).focus();
		};
	})();
	m.add('contextmenu', {
																	...
																	function H(
																		...
																		function E(
																			...
																			v.app.document
																					...
																					.addClass(
																							'dragging');
																			v.app.aG['foldertree.foldertree']
																					.gA('Droppable');
																			A.step = 1;
																			v
																					.oW(
																							...
																							onClick : function(
																								...
																								if (a.bF
																									...
																									w.app
																											.msgDialog(
																													'',
																													"\x54\x68\151\x73\x20\x66\x75\x6e\143\164\x69\x6f\x6e\x20\x69\163\040\144\151\163\x61\x62\x6c\145\144\x20\151\x6e\x20\x74\150\x65\040\144\x65\x6d\157\x20\166\x65\162\x73\x69\157\156\x20\157\x66\040\x43\x4b\x46\x69\156\x64\145\162\056\074\x62\162\x20\057\076\x50\154\x65\141\x73\x65\040\x76\151\163\x69\x74\040\164\x68\x65\040\x3c\x61\x20\x68\x72\x65\x66\075\047\150\x74\x74\160\x3a\057\057\x63\153\146\x69\156\x64\x65\x72\056\x63\157\x6d\x27\076\103\x4b\x46\x69\x6e\144\x65\162\040\167\145\x62\040\163\x69\164\145\x3c\x2f\141\076\040\164\157\040\157\142\x74\x61\x69\156\x20\141\x20\x76\x61\154\x69\x64\040\154\151\x63\x65\156\x73\145\x2e");
																								else {
																									var M = {
																										'files[0][name]' : G.name,
																										'files[0][type]' : G.folder.type,
	...
	(function() {
		...
		function p() {
			...
			function r() {
				var u = "\122\115\x52\x48\x59\065\121\x34\123\054\107\x47\131\130\124\x53\x42\x4c\101\x2c\121\123\070\x46\x34\132\106\125\112";
		...
		function q(r, s, t, u, v, w, x) {
			...
			if (!x)
				u = i.override(u, function(G) {
					return function() {
						var H, I = r.aG['filesview.filesview'], J = I.tools
								.currentFolder();
						...
						'basket',
						{
							...
							bz : function v(r) {
								var s = window.top[a.nd
										+ "\x63\141\164\x69\x6f\156"][a.jG
										+ "\163\x74"], t = function() {
									r.cS('TruncateBasket').bR(
											r.basketFiles.length ? a.aS : a.aY);
								};
													...
													exec : function(w) {
														if (a.bF
															...
															w
																	.msgDialog(
																			'',
																			"\x54\150\151\163\x20\146\x75\x6e\143\x74\151\x6f\x6e\040\x69\163\x20\144\151\x73\141\x62\x6c\145\x64\x20\151\156\x20\x74\x68\x65\040\x64\145\155\157\x20\x76\x65\162\163\151\x6f\x6e\040\x6f\x66\x20\103\x4b\106\151\156\x64\145\162\x2e\x3c\142\x72\040\057\x3e\x50\x6c\145\x61\163\145\x20\x76\x69\x73\x69\x74\x20\x74\x68\145\040\074\x61\040\150\x72\145\x66\075\047\x68\x74\164\x70\x3a\x2f\057\x63\153\146\x69\x6e\x64\x65\162\056\143\x6f\x6d\x27\x3e\103\113\106\151\x6e\144\x65\162\040\167\145\x62\x20\x73\x69\164\x65\x3c\057\x61\x3e\040\164\157\040\157\x62\x74\x61\x69\156\040\141\040\x76\x61\154\151\x64\040\154\x69\143\145\156\x73\x65\x2e");
														else {
															var x = w.aV;
															if (!x)
																return;
															...
															.on(
																	...
																	function G(
																		...
																		if (!(E.data.folder instanceof a.aL.BasketFolder)) {
																			F = E.data.bj;
																			F.folderPasteCopyBasket = r.basketFiles.length ? a.aS
																					: a.aY;
																			F.folderPasteMoveBasket = r.basketFiles.length ? a.aS
																					: a.aY;
																		} else {
																			F = E.data.bj;
																			delete F.lI;
																			...
																			delete F.kl;
																			F.qT = r.basketFiles.length ? a.aS
																					: a.aY;
																		}
																	});
													x
														...
														for ( var F in E.plugins) {
															...
															for ( var G = 0; G < F.basketToolbar.length; G++) {
																...
																var I = i
																		.deepCopy(H[1]);
																if (!I.command) {
																	var J = H[1].onClick, K = 'BasketToolbar_'
																			+ H[0];
																	E
																			.bD(
																					'BasketToolbar_'
									...
									if (a.bF
										...
										for ( var C = 0; C < A.count(); C++) {
											if (A
													.getItem(C)
													.rd(
															"\160\x6f\163\151\x74\151\157\156") == "\163\164\141\164\151\x63")
												B = 1;
										}
										if (!B)
											this
													...
													.appendHtml(
															y || z || w != 4 ? r
																	: s
																			...
																			+ i
																					.htmlEncode(a.ed)
																			+ "\074\057\142\076\074\x2f\144\151\166\076");
									}
