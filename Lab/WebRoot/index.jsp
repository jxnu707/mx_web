...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 <body>
	<div class="wrapper sticky_footer">
    	...
    	<!-- HEADER END -->
        <div class="inner_copyright">Collect from <a href="http://www.cssmoban.com/" target="_blank" title="��վģ��">��վģ��</a></div>
        <!-- CONTENT BEGIN -->
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <h3 style="font-size:16px;">Member Profile</h3>
                        ...
                        <div class="block_home_col_1">
                        	<div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.html">There are many variations of of available, but the majority.There are many variations of of available, but the majority.There are many variations of of available, but the majority.There are many variations of of available, but the majority.There are many variations of of available, but the majority.</a></p>
                        ...
                        <div class="block_topic_news">
                        	<article class="block_topic_post2">
                            	<p class="title"><a href="news_post.html">Many desktop publishing packages and web page editors now use.</a></p>
                                
                                <p class="text">There are many variations of passages of available, but the majority have alteration.There are many variations of passages of available, but the majority have alteration.There are many variations of passages of available, but the majority have alteration.There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2012</p></div>
                            ...
                            <article class="block_topic_post2">
                                ...
                                <p class="text">There are many variations of passages of available, but the majority have alteration.There are many variations of passages of available, but the majority have alteration.There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2012</p></div>
                            ...
                            <article class="block_topic_post2">
                                ...
                                <div class="info">
                                    ...
                                    <div class="r_part">
                                    	<div class="category"><p><a href="#">Click</a></p></div>
                                        <a href="#" class="views">183</a>
                                    </div>
                                </div>
                            </article>
